...
<head>
    ...
    <title> Usuario |Grupo Intercom</title>
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                      ...
                      <button type='button' class="btn btn-success" data-toggle="modal" onclick="NuevoUsuario();" ><i class="fas fa-plus"></i>  Agregar Usuario </button>
                    </div>
