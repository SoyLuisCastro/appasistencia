...
<head>
    ...
    <title>Estudiantes| Grupo Intercom</title>
               ...
               <?php include 'header.php';?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-fw fa-user-plus"></i> Gestion Pasantes </h1>
                        ...
                        <div class="col-xl-12">
                         ...
                         ?>
                                    <div class="btn-group pull-left">
                                        ...
                                        <button <?php echo $etiqueta ?> type='button' class="btn btn-success" data-toggle="modal" onclick="NuevoEstudiante();"><span class="fas fa-plus"></span> Agregar Pasante </button>
                    </div>
                                    <?php 
                         }else{
                             ?>
                                    <div class="btn-group pull-left">
                                        ...
                                        <button  type='button' class="btn btn-success" data-toggle="modal" onclick="NuevoEstudiante();"><span class="fas fa-plus"></span> Agregar Pasante </button>
                    </div>
                                    <?php
