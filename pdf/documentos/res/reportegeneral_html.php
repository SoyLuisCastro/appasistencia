...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
     ...
     <table cellspacing="0" style="width: 100%;">
        <tr>
            ...
            <img style="width: 70%;" src="../../img/logo_intercom.png" > 
            </td>
             <td style="width: 50%; color: #34495e;font-size:12px; text-align: center">
             <span style="color: #34495e;font-size:14px;font-weight:bold"><?php echo "GRUPO INTERCOM";?></span>
				<br> Direccion :<?php echo "Calles: jose santos y pedro jimenes , segundo piso referencia a lado Orve Hogar";?><br> 
...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
           <tr>
           		<td style="width:100%;" class='midnight-blue'>REPORTE GENERAL DE PASANTES</td>
           </tr>
</table>
...
//      $prueba=$_GET['prueba_p'];
     $nums=1;
    $sql="select tb_estudiantes.nombres_apellidos,tb_estudiantes.cedula,tb_estudiantes.correo,tb_cursos.descripcion as periodo,tb_jornadas.descripcion as jornada,tb_carreras.siglas as carrera
...
and tb_estudiantes.id_carreras= tb_carreras.id_carreras and tb_estudiantes.id_cursos= tb_cursos.id_cursos and tb_estudiantes.estado=1 ;";
