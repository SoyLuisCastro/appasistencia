...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
           <tr>
           		<td style="width:100%;" class='midnight-blue'>REPORTE DE ASISTENCIA </td>
           </tr>
</table>
...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 23px;" >
    ...
    <tr>
     ...
     <?php 
     $nums=1;
    $sql="SELECT tb_estudiantes.nombres_apellidos,tb_carreras.siglas AS carreras,tb_jornada2.descripcion AS jornada,
...
AND tb_asistencia.id_jornada2= tb_jornada2.id_jornada2 AND tb_asistencia.id_carreras = tb_carreras.id_carreras AND tb_asistencia.id_carreras='$idCarrera' ;";
        $result= mysqli_query($objConexion, $sql);
        while($sqlArray= mysqli_fetch_array($result)){
            
            $NombrePersona=$sqlArray['nombres_apellidos'];
            $jornadass=$sqlArray['jornada'];
            $careee=$sqlArray['carreras'];
