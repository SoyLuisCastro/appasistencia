...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
           <tr>
           		<td style="width:100%;" class='midnight-blue'>REPORTE DE ASISTENCIA POR PASANTE </td>
           </tr>
</table>
...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 23px;" >
    ...
    <tr>
     ...
     <?php 
     $nums=1;
    $sql="SELECT tb_estudiantes.nombres_apellidos,tb_carreras.siglas AS carrera,tb_jornada2.descripcion AS jornada,tb_asistencia.fecha,
