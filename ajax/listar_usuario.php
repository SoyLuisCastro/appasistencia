         ...
         <tbody>
					<?php while($fila = $result->fetch_assoc()) { 
						...
						<tr>
                            ...
                            if($idrolUsuario==1){
                            ?>    
                            <button  class='btn btn-info' title='Editar Usuario' onclick="editarUsuario(<?php echo $fila['id_usuario']?>)"><i class="fas fa-pencil-alt"></i></button>
                                                            <button  class='btn btn-danger' title='Eliminar Usuario' onclick="eliminarUsuario(<?php echo $fila['id_usuario']?>)"><i class="fas fa-trash"></i></button>
